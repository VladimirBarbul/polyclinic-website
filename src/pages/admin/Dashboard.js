...
import { updateClinicContacts } from '../../utils/clearCache';
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-gray-600">
          Керуйте контентом вашого сайту
        </p>
      </div>
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  ...
                  <dd className="text-lg font-medium text-gray-900">
                    <Link to="/admin/doctors" className="text-blue-600 hover:text-blue-500">
                      Керувати лікарями
                    </Link>
                  </dd>
                </dl>
            ...
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  ...
                  <dd className="text-lg font-medium text-gray-900">
                    <Link to="/admin/services" className="text-blue-600 hover:text-blue-500">
                      Керувати послугами
                    </Link>
                  </dd>
                </dl>
            ...
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  ...
                  <dd className="text-lg font-medium text-gray-900">
                    <Link to="/admin/vacancies" className="text-blue-600 hover:text-blue-500">
                      Керувати вакансіями
                    </Link>
                  </dd>
                </dl>
            ...
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  ...
                  <dd className="text-lg font-medium text-gray-900">
                    <Link to="/admin/contacts" className="text-blue-600 hover:text-blue-500">
                      Керувати контактами
                    </Link>
                  </dd>
                </dl>
            ...
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  ...
                  <dd className="text-lg font-medium text-gray-900">
                    <Link to="/admin/emailjs" className="text-blue-600 hover:text-blue-500">
            ...
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  ...
                  <dd className="text-lg font-medium text-gray-900">
                    <Link to="/admin/social" className="text-blue-600 hover:text-blue-500">
                      Керувати соціальними мережами
                    </Link>
                  </dd>
                </dl>
              </div>
